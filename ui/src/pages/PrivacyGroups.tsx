    ...
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 rounded-2xl border border-ink-700 bg-ink-900/60 p-5">
        ...
        <p className="mt-3 text-[14px] leading-relaxed text-slate-300">
          ...
          ledger</em> and <em>can an outside observer read the amount</em> — and the Keys &amp; Encryption tab of
          this app proves the second half with a real transfer, a real auditor key, and real on-chain data.
        </p>
      </div>
    </div>
  )
